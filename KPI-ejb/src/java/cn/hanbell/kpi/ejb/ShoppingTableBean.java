...
public class ShoppingTableBean extends SuperEJBForKPI<ShoppingTable> {
    ...
    public void updateSHBType(Date d) {
        ...
        this.getEntityManager().createNativeQuery(String.format("update shoppingtable set type='刀具',iscenter=1 where facno='C' and yearmon like '%s' and vdrno  in  (select vdrno from shoppingmanufacturer where facno='C' and  materialTypeName ='刀具')and itcls  in('BS1','B001','C002','B006');", yearmon)).executeUpdate();
