...
@Stateless
@LocalBean
public class BscGroupVBHShipmentBean implements Serializable {
    ...
    public BscGroupVBHShipmentBean() {
    }
    ...
    public void updataShpimentActualValue(int y, int m, Date d) {
        ...
        if (resultData != null) {
            erpEJB.setCompany("C");
            erpEJB.getEntityManager().createNativeQuery("delete from bsc_groupshipment where facno='VB' and year(soday)=" + y + " and month(soday) = " + m + " and type = 'Shipment'").executeUpdate();
    ...
    protected List<BscGroupShipment> getShipment(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            for (int i = 0; i < shpResult.size(); i++) {
                ...
                BscGroupShipment e = new BscGroupShipment("VB", shpdate, "Shipment", protype, protypeno, shptype);
                e.setQuantity(qty);
            ...
            Logger.getLogger(BscGroupVBHShipmentBean.class.getName()).log(Level.SEVERE, null, ex);
        }
        return data;
    }
    ...
    public void updataServerActualValue(int y, int m, Date d) {
        ...
        if (resultData != null) {
            erpEJB.setCompany("C");
            erpEJB.getEntityManager().createNativeQuery("delete from bsc_groupshipment where facno='VB' and year(soday)=" + y + " and month(soday) = " + m + " and type = 'ServiceAmount' ").executeUpdate();
            for (BscGroupShipment e : resultData) {
                erpEJB.getEntityManager().persist(e);
            }
        }
    ...
    protected List<BscGroupShipment> getServiceValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            for (int i = 0; i < shpResult.size(); i++) {
                ...
                BscGroupShipment e = new BscGroupShipment("VB", shpdate, "ServiceAmount", protype, protypeno, shptype);
