 ...
 * @author C1749
 */
public class InventoryAmountA2C15 extends InventoryAmountA2 {

    public InventoryAmountA2C15() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        IndicatorDetail o1 = i.getOther6Indicator();//济南分公司
        try {
