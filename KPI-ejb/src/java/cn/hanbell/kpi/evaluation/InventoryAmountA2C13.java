 ...
 * @author C1749
 */
public class InventoryAmountA2C13 extends InventoryAmountA2 {

    public InventoryAmountA2C13() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        IndicatorDetail o1 = i.getOther4Indicator();//广州分公司
        try {
