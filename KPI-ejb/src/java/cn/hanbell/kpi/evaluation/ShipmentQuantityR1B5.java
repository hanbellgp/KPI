 ...
 * @author C0160
 */
public class ShipmentQuantityR1B5 extends ShipmentQuantity {

    public ShipmentQuantityR1B5() {
        super();
 ...
 @Override
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        try {
            ...
            Indicator indicator = getIndicatorBean().findByFormidYearAndDeptno("R-华东盐水R均价", y, "1F000");
