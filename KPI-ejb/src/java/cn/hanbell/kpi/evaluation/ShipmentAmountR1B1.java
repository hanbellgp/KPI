 ...
 * @author C0160
 */
public class ShipmentAmountR1B1 extends ShipmentAmount {
IndicatorBean indicatorBean = getIndicatorBean();
    public ShipmentAmountR1B1() {
        super();
  ...
  @Override
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        try {
            ...
            Indicator indicator = indicatorBean.findByFormidYearAndDeptno("R-华东空调R均价", y, "1F000");
