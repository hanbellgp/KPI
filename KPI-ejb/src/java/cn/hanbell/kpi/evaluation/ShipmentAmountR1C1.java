 ...
 * @author C0160
 */
public class ShipmentAmountR1C1 extends ShipmentAmount {

    public ShipmentAmountR1C1() {
        super();
        ...
        //SHB + GZ
         Field f;
           ...
           String deptno = queryParams.get("deptno") != null ? queryParams.get("deptno").toString() : "";
            Indicator indicator = getIndicatorBean().findByFormidYearAndDeptno("R-济南空调R均价", y, "1F000");
            ...
            a4 = Double.valueOf(f.get(o4).toString());
             ...
             //华东销售金额=华东销售台数+分公司卖出后新增到华东-华东卖给分公司的金额
