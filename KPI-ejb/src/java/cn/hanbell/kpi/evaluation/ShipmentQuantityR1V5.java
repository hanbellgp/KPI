 ...
 * @author C0160
 */
public class ShipmentQuantityR1V5 extends ShipmentQuantity {

    public ShipmentQuantityR1V5() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        //SHB + GZ
           ...
           String deptno = queryParams.get("deptno") != null ? queryParams.get("deptno").toString() : "";
            Indicator indicator = getIndicatorBean().findByFormidYearAndDeptno("R-重庆盐水R均价", y, "1F000");
