 ...
 * @author C1749
 */
public class InventoryAmountA2C11 extends InventoryAmountA2 {

    public InventoryAmountA2C11() {
        super();
        ...
        queryParams.put("genzls", "C10");//暂时都用C10
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        IndicatorDetail o1 = i.getOther2Indicator();//华东本部
        try {
