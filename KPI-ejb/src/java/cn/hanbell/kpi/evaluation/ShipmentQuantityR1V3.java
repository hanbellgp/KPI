 ...
 * @author C0160
 */
public class ShipmentQuantityR1V3 extends ShipmentQuantity {

    public ShipmentQuantityR1V3() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        //SHB + GZ
           ...
           String deptno = queryParams.get("deptno") != null ? queryParams.get("deptno").toString() : "";
            Indicator indicator = getIndicatorBean().findByFormidYearAndDeptno("R-重庆冷冻R均价", y, "1F000");
