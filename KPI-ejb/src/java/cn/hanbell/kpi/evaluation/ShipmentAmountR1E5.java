 ...
 * @author C0160
 */
public class ShipmentAmountR1E5 extends ShipmentAmount {

    public ShipmentAmountR1E5() {
        super();
        ...
        //SHB + GZ
         Field f;
           ...
           String deptno = queryParams.get("deptno") != null ? queryParams.get("deptno").toString() : "";
            Indicator indicator = getIndicatorBean().findByFormidYearAndDeptno("R-南京盐水R均价", y, "1F000");
